...
def count_coin_combos_recursive(n, coin=7):
    ...
    def recursive_combos(num, coin_index):
        ...
        combos = 0
        while target >= 0:
            print(f"Recursion target={target} coin={coin_index} combos={combos}")
    ...
    return recursive_combos(n, coin)
...
if __name__ == '__main__':
    print(count_coin_combos_recursive(5))
