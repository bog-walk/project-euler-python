import unittest
from solution.batch2.problem18 import max_path_sum


class MaximumPathSum1(unittest.TestCase):
    def test_max_path_sum_small(self):
        elements = [3, 7, 4, 2, 4, 6, 8, 5, 9, 3]
        self.assertEqual(23, max_path_sum(4, elements))

    def test_max_path_sum_large(self):
        elements = [
        ...
        self.assertEqual(1074, max_path_sum(15, elements))
